...
def check_out_function():
    ...
    cmdlet_check_out = "D:" + '\\'+"vdClient\VDogAutoCheckOut.exe" + ' /' +"rd:d:"+ '\\' + "vdogData /at:c /dirR:\Training"+ '\\' +"test_duy\ASCII /CID:891F9A068AFD464ABD8AB29D5A8BD8FF /Password:Haha050399@@ /Account:tad6hc /Domain:apac"
    try:
...
def check_in_fucntion():
    ...
    try:
        cmdlet_check_in = "D:" + '\\'+"vdClient\VDogAutoCheckIn.exe" + " /RD:D:" + '\\' "vdogData /AT:C /CFile:D:\AutoCheckIn.ini /Password:Haha050399@@ /Account:tad6hc /Domain:apac"
...
def create_json_report():
    ...
    with open("D:/vdServerArchive/report_1_060.json", 'w') as f:
