            ...
            if check is False:
                for path_check_version in list_path_subfolder_achieve:
                    ...
                    if x:
                        ...
                        if float((datetime.date.today() - date_packup_file).days)* 0.002738 > float(0):
...
def create_report():
    with open("D:/vdSA/report_153.csv",'w', newline='', encoding="UTF-8") as f:
...
def create_json_report():
    ...
    with open("D:/vdSA/report_3_153.json", 'w') as f:
