...
def check_out_function():
    ...
    # cmdlet_check_out = r"D:\vdClient\VDogAutoCheckOut.exe /rd:d:\vdCA /at:c /dirR:\Ba\test\Json3 /CID:CDFCBC9C02CB4E238B91125CD1E38AF6 /Account:tad6hc /Password:{} /Domain:APAC".format(password)
    cmdlet_check_out = "D:" + "\\"+ "vdClient\VDogAutoCheckOut.exe /rd:d:"+"\\"+ "vdCA /at:c /dirR:\Ba"+ "\\"+ "test\Json3 /CID:CDFCBC9C02CB4E238B91125CD1E38AF6 /Account:tad6hc /Password:Haha050399@@@ /Domain:APAC"
    try:
...
def check_in_fucntion():
    ...
    try:
        # cmdlet_check_in = r"D:\vdClient\VDogAutoCheckIn.exe /RD:D:\vdCA /AT:C /CFile:D:\AutoCheckIn.ini /Password:{} /Account:tad6hc /Domain:APAC".format(password)
        cmdlet_check_in = "D:"+ "\\" + "vdClient\VDogAutoCheckIn.exe /RD:D:"+ "\\" + "vdCA /AT:C /CFile:D:\AutoCheckIn.ini /Password:Haha050399@@@ /Account:tad6hc /Domain:APAC"
...
def create_json_report():
    ...
    with open("D:/vdSA/Report_Daily/report_1_153.json", 'w') as f:
