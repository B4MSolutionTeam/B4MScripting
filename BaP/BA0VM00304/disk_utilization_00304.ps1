$path = "D:\Automation\Report_File\report_3_$([System.Net.Dns]::GetHostName()).json"
...
function Copy_To_Bulk
{
    ...
    . "D:\Automation\Script_Automation\get_pam_password.ps1"
...
if ((Test-Path -Path $path -PathType Leaf) -eq $false)
{
    ...
    Copy_To_Bulk -path_local $path -path_bulk $bulk_path
}
else {
