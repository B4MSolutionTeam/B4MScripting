function check_in_function
{
    ...
    try
    {
        ...
        $status_checkin = C:\TEF\vdogClient\VDogAutoCheckIn.exe /rd:C:\Users\RBAdmin_App1\Desktop\vdCA /AT:C /CFile:$ini_file /Account:bmt8hc /Domain:APAC /Password:$password_string
...
function check_out_function
{
    ...
    try {
        $status_checkout = C:\TEF\vdogClient\VDogAutoCheckOut.exe /rd:C:\Users\RBAdmin_App1\Desktop\vdCA /AT:C /dirR:\TestArea-FeP\B4M_tad6hc\XML_Test \CID:9BB8DD2663B8524BA9202024FAFBAFF7 /Account:bmt8hc /Domain:APAC /Password:$password_string
...
function create_json_report 
{
    ...
    $path_json = "D:\Automation_Task_Report_File\report_1_2752.json"
