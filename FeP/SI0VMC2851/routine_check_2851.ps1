function check_in_function
{
    ...
    try
    {
        ...
        $status_checkin = C:\TEF\vdogClient\VDogAutoCheckIn.exe /rd:C:\Users\RBAdmin_App1\Desktop\vdCA /AT:C /CFile:D:\Automation_Task_Script\CheckIn.ini /Account:bmt8hc /Domain:APAC /Password:
